...
import edesur.rdd.srv.BeanAggregationStrategy;
...
public class SuministroRouteBuilder extends BaseRouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:getSuministro")
                ...
                .to("sql:classpath:sql/suministro.sql?dataSource=#SynergiaDS&outputType=SelectOne&outputClass=edesur.rdd.srv.model.SuministroResultado")
                .choice()
                    .when(body().isNull())
