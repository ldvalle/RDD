...
import edesur.rdd.srv.model.CorteRepoResultado;
    ...
    public void configure() throws Exception {
        ...
        from("direct:setConsultaCorteRepo")
          ...
          //.to("sql:classpath:sql/ConsultaCorteRepo.sql?dataSource=#SynergiaDS&outputType=SelectList&outputClass=edesur.t1.srv.model.ConsultaCorteRepoResponse")
			 .to("sql:classpath:sql/ExisteCliente.sql?dataSource=#SynergiaDS&outputType=SelectOne&outputClass=edesur.rdd.srv.model.ConsultaCorteRepoResponse")
			 ...
			 .otherwise()
				.enrich("sql:classpath:sql/ConsultaCorteRepo.sql?dataSource=#SynergiaDS&outputType=SelectList&outputClass=edesur.rdd.srv.model.CorteRepoResultado", listaResultado )
